...
def load_embeddings(embed_path: str,
    ...
    saved_data = torch.load(embed_path, map_location="cpu")
    learned_embeds_dict = saved_data['learned_embeds_dict']
    name2placeholder = saved_data['name2placeholder']
    ...
    for token, token_embedding in learned_embeds_dict.items():
        ...
        # get the id for the token and assign new embeds
        embeddings.weight.data[added_token_id] = token_embedding.to(embeddings.weight.dtype)
